    ...
    <main className="app-shell-compact app-page-stack py-3 sm:py-5">
      ...
      <section className="app-panel app-reveal p-4 text-slate-900 sm:p-5">
        ...
        <h1 className="font-display mt-2 text-2xl font-semibold leading-tight">
          Создайте безопасную одноразовую ссылку
        </h1>
        <p className="app-muted mt-2 text-sm leading-relaxed">
          Отправьте ссылку только партнёру. Она не показывает ваше имя, внутренний ID пары
          или причину, по которой приглашение может стать недоступным.
        </p>
      </section>
          ...
          {status === 'ACTIVE' && !shareLink && (
            <div className="app-alert app-alert-auth mt-4">
              ...
              <p className="mt-1 text-sm">
                Из соображений безопасности старая ссылка не восстанавливается после повторного
                входа. Перевыпустите её, чтобы получить новую.
              </p>
            </div>
          )}
