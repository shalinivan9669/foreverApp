  ...
  return <main className="app-shell-menu py-4 sm:py-6">
    ...
    <section className="mt-6" aria-labelledby="menu-sections">
      ...
      <nav className="grid grid-cols-1 gap-3 min-[360px]:grid-cols-2 lg:grid-cols-3" aria-label="Основные разделы">
        ...
        <Link href="/questionnaires" className="app-tile app-tile-mint p-4 sm:p-5"><span className="text-xl font-semibold">Анкеты</span><p className="mt-2 text-sm leading-relaxed">Разобрать навыки по темам, продолжить ответы и посмотреть результаты.</p></Link>
