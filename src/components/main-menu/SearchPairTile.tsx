      ...
      <div className="relative z-10">
        <div className="mx-auto mb-1 flex h-8 w-8 items-center justify-center rounded-full bg-white/70 shadow-sm">
          {hasActive ? (
            ...
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M10 18a8 8 0 1 1 5.293-2.707l3.707 3.707-1.414 1.414-3.707-3.707A7.963 7.963 0 0 1 10 18z"/></svg>
          )}
        </div>
