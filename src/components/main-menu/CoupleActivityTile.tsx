...
export default function CoupleActivityTile() {
  return (
    <Link
      ...
      className="app-tile app-tile-aura app-reveal flex h-full min-h-[7rem] items-center justify-center px-3 text-center font-semibold tracking-wide sm:min-h-[8rem]"
    >
